<%@ Page Language="C#" MasterPageFile="~/Common/MasterPage.Master" AutoEventWireup="true" CodeBehind="WfrmVCB_TS.aspx.cs" Inherits="BIDVWEB.BIDV_UC.SearchMessage.WfrmVCB_TS" Title="MSBGW_WEB" %>
                    ...
                    <asp:GridView ID="grvData" runat="server" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Chi tiết">
                                <ItemTemplate>
                                    <a href='../SearchMessage/WfrmViewVCB_TS.aspx?mn=2402&ID=<%# Eval("ID") %>&vi=0' target="_blank">
                                    Chi tiết</a>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Center" />
                            ...
                            <asp:TemplateField HeaderText="Tra soát">
                                <ItemTemplate>
                                    <a href='../SearchMessage/WfrmViewVCB_TS.aspx?mn=2402&ID=<%# Eval("ID") %>&vi=1' target="_blank">
                                    <%# Eval("TTS") %></a>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" Width="50px" />
