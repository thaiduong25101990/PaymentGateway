<%@ Page Language="C#" MasterPageFile="~/Common/MasterPage.Master" AutoEventWireup="true" CodeBehind="WfrmSWIFT_TS.aspx.cs" Inherits="BIDVWEB.BIDV_UC.SearchMessage.WfrmSWIFT_TS" Title="MSBGW_WEB" %>
    ...
    <br/>
        <table id="Table1" runat="server" width="740px" class="DialogContentSmall">
            ...
            <tr align="left">
                ...
                <td>
                    <asp:Label ID="Label10" runat="server" Text="Chiều điện" Visible ="false"></asp:Label>
                </td>
                <td>
                    ...
                    <asp:GridView ID="grvData" runat="server" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Chi tiết">
                                <ItemTemplate>
                                    <a href='../SearchMessage/WfrmViewSWIFT_TS.aspx?mn=2302&ID=<%# Eval("ID") %>&vi=0' target="_blank">
                                    Chi tiết</a>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Center" />
                            ...
                            <asp:TemplateField HeaderText="Tra soát">
                                <ItemTemplate>
                                    <a href='../SearchMessage/WfrmViewSWIFT_TS.aspx?mn=2302&ID=<%# Eval("ID") %>&vi=1' target="_blank">
                                    <%# Eval("TTS") %></a>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" Width="50px" />
