    ...
    function constructMonth() {
        ...
        if (!monthConstructed) {
            ...
            for (i=0; i<12; i++) {
                ...
                sHTML += '<tr><td id="m' + i + '" class="pcalList" onmouseover="this.style.backgroundColor=\'#909090\'" onmouseout="this.style.backgroundColor=\'\'" onclick="selectMonth(' + i + ')">&nbsp;' + sName + '&nbsp;</td></tr>';
            }
    ...
    function constructYear() {
        ...
        if (!yearConstructed) {
            ...
            for ( i = (yearSelected-3); i <= (yearSelected+3); i++ ) {
                ...
                sHTML += '<tr><td id="y' + j + '" class="pcalList" onmouseover="this.style.backgroundColor=\'#909090\'" onmouseout="this.style.backgroundColor=\'\'" onclick="selectYear('+j+')">&nbsp;' + sName + '&nbsp;</td></tr>';
                j++;
            }
