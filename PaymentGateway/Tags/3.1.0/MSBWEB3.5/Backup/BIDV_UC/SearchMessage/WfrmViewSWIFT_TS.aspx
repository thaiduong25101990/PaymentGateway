<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WfrmViewSWIFT_TS.aspx.cs" Inherits="BIDVWEB.BIDV_UC.SearchMessage.WfrmViewSWIFT_TS" Title="MSBGW_WEB" %>
<!--
        ...
        cellpadding="0" cellspacing="0" border="0">
            <tr>
                <td align="center" colspan="4" class="DialogCaption" style="height:25px">
                    <asp:Label ID="Label6" runat="server" Font-Bold="True" Text="ĐIỆN TRA SOÁT NỘI BỘ SWIFT" 
            ...
            <tr align="left">
                ...
                <td>
                    <asp:TextBox ID="txtDVYC" runat="server" Width="250px" 
            ...
            <tr align="left">
                ...
                <td>                    
                    <asp:Label ID="Label30" runat="server" Text="CN tạo điện"></asp:Label>
                </td>
                <td>
            ...
            <tr align="left">
                ...
                <td>
                    <asp:Label ID="Label9" runat="server" Text="CN nhận điện"></asp:Label>
                </td>
                <td>
            ...
            <tr align="left">
                ...
                <td>
                    <asp:Label ID="Label10" runat="server" Text="Số lệnh TS">
                    </asp:Label>
                    <asp:Label ID="Label16" runat="server" Text="Chiều điện" Visible="false"></asp:Label>
                </td>
                <td>
