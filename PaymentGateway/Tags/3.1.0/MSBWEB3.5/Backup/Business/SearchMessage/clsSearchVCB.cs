    ...
    public class clsSearchVCB
    {
        ...
        public DataSet SearchAdvance(string pWHERE, string pDateFrom, string pDateTo)
        {
            try
            {
                ...
                string strSQL = "GW_PK_VCB_SEARCH.Search_VCB";
        ...
        // Dau ra:      
        /////////////////////////////////////////////////////////////
        public DataSet GetMsgVCBByID(string sMsg_id)
        {
            try
            {
                string strSQL = "";
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        oraParas3[0].Value = "VCB_MSG_ALL_HIS";
