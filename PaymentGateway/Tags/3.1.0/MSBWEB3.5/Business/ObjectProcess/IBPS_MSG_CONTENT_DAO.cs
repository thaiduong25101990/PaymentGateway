...
namespace BIDVWEB.Business
{
    public class IBPS_MSG_CONTENTDP
    {
        ...
        {
            string strSql = "GW_PK_IBPS.IPBS_UPDATE_PRINT_STS";
         ...
         * Nguoi tao: Huypq7         
         //////////////////////////////////////////////////*/
        public int Check_Print_STS(IBPS_MSG_CONTENTInfo objTable)
        {
            string strSql = "GW_PK_IBPS.CHECK_IPBS_PRINT_STS";
            int iReturn = 0;
            ...
            try
            {
                ...
                if (oraConn == null)
                    return -1;
                clsDatatAccess.ExecuteNonQuery(oraConn, 
