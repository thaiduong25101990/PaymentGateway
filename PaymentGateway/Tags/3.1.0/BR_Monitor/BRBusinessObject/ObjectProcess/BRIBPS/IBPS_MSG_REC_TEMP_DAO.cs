...
{
    public class IBPS_MSG_REC_TEMDP
    {
        OracleConnection oraConn = new OracleConnection();
        Connect_Process conn = new Connect_Process();
        public IBPS_MSG_REC_TEMDP()
        {
        }
        public static IBPS_MSG_REC_TEMDP Instance()
        {
            return new IBPS_MSG_REC_TEMDP();
        }

        public int AddIBPS_MSG_REC_TEM(IBPS_MSG_REC_TEMPInfo objTable)
        {
            string strSql = "INSERT INTO IBPS_MSG_REC_TEMP (GW_TYPE, ACC_NUM, ";
            strSql = strSql + "ACC_TYPE, RUNNING_SEG_NO, REF_NO, MSG_TYPE, SEG_NO, MSG_NO, CCY, AMOUNT, APP_CODE, SENDER, ORG_BANK, ";
            strSql = strSql + "RECEIVING_BRANCH, RECEIVER, VALUE_DATE, JOURNAL_SEG_NO, MSG_DIRECTION, FROM_SYSTEM, TO_SYSTEM, TRANS_DATE)";
            ...
            strSql = strSql + ":pRECEIVING_BRANCH, :pRECEIVER, :pVALUE_DATE, :pJOURNAL_SEG_NO, :pMSG_DIRECTION, :pFROM_SYSTEM, :pTO_SYSTEM, :pTRANS_DATE)";
        ...
        {
            string strSql = "DELETE FROM IBPS_MSG_REC_TEMP";
        ...
        public DataSet GetIBPS_MSG_REC_TEM(string strDirection, string strDepartment)
        {
            ...
            string strSQL = "Select * from IBPS_MSG_REC_TEMP Where Upper(APP_CODE)='" + strDepartment + "' AND Upper(MSG_DIRECTION) ='" + strDirection + "' order by ACC_NUM, ACC_TYPE, SEG_NO ASC";
