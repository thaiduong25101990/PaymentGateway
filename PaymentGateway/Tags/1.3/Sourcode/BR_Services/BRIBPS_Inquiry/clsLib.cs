...
namespace BRIBPSInquiry
{
    public class Lib
    {
        ...
        private const string LOG_FILENAME = "BRIBPSInquiry_Service.log";
        ...
        public static void WriteLogDB(int LogLevel, string Content, long lQueryID)
        {
            try
            {
                    ...
                    OracleParameter[] parameters = new OracleParameter[]
                {
                    ...
                    parameters[2].Value = "BRIBPSInquiry";
       ...
       *--------------------------------------------------------------*/
        ...
        *--------------------------------------------------------------*/
        ...
        public static DataTable ExcuteDataTable(string cmdText, CommandType cmdType, params OracleParameter[] para)
        {
