...
namespace BRSWIFTRMMaintaince
{
    public class Lib
    {
        ...
        private const string LOG_FILENAME = "BRSWIFTRMMaintaince_Service.log";
        ...
        public static bool WriteFile(string DirPath, string FileName, string strContent)
        {
            ...
            try
            {
                ...
                {
                    WriteLogDB(1, "File duplicate: " + FileName, 1);
                    return false;
                }
        ...
        public static void WriteLogDB(int LogLevel, string Content, long lQueryID)
        {
            ...
            try
            {
                ...
                //    new OracleParameter("pService",SWIFTRMMaintaince.SERVICE_NAME),
                ...
                parameters[2].Value = "BRSWIFTRMMaintaince";
        ...
        ********************************************************************/
        ...
        public static string getKeyConfig(string key)
        {
            ...
            try
            {
                ...
                {
                    // add value for key
                    throw new Exception("Can not found key " + key + " in config file of service.");
                }
                else
                {
