...
static unsigned char ASCII_translate_EBCDIC [ 256 ] =
    ...
    0x09, 0x25, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F,
...
void    EBCDIC_to_ASCII ( long buf_length, unsigned char *buf_addr)
{   int i;
    unsigned char temp;
...
void    ASCII_to_EBCDIC ( long buf_length, unsigned char *buf_addr)
{   int i;
    unsigned char temp;
    for (i=0; i < buf_length; i++)
    {
