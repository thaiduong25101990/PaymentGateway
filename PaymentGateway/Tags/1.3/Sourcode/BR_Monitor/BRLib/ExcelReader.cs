	...
	public class ExcelReader : IDisposable
	{
		...
		private string ExcelConnection()
		{
			return
               ...
               Data Source=" + _strExcelFilename + @";Extended Properties=""Excel 12.0;HDR=NO;""";
        ...
        public DataTable GetTable(int Columns)
		{
            return GetTable("ExcelTable", Columns);
		}
        ...
        public DataTable GetTable(string strTableName, int Columns)
			...
			try
			{
				...
				if (this.Headers ==false)
				{
					if (_strSheetRange.IndexOf(":")>0)
					{
                        ...
                        {
                            for (int icot = dt.Columns.Count; icot < Columns; icot++)
                            {
                                dt.Columns.Add();
                            }
                        }
