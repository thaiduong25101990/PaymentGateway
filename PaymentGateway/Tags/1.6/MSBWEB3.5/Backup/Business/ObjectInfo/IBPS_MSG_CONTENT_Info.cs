...
{
    public class IBPS_MSG_CONTENTInfo
    {
        ...
        private string _TAD;
        private string _PRE_TAD;
        private string _RM_NUMBER;
        private Object _HV_LV;
        private string _TELLERID;
        private int _PRINT_STS;
        public IBPS_MSG_CONTENTInfo()
        {
        ...
        public int SIBS_TRANS_NUM
        {
            get
            {
                return _SIBS_TRANS_NUM;
            }
            set
            {
                _SIBS_TRANS_NUM = value;
            }
        }
        ...
        public string TRANS_DESCRIPTION
        {
            get
            {
                return _TRANS_DESCRIPTION;
            }
            set
            {
                _TRANS_DESCRIPTION = value;
            }
        }
        ...
        public string SOURCE_BRANCH
        {
            get
            {
                return _SOURCE_BRANCH;
            }
            set
            {
                _SOURCE_BRANCH = value;
            }
        }
