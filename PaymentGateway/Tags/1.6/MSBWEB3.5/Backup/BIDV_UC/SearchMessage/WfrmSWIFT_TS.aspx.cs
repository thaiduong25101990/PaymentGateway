...
{
    public partial class WfrmSWIFT_TS : System.Web.UI.Page
    {
        ...
        {            
            try
            {
                ...
                ds = objSWIFT_TS_BO.SearchAdvance(strWhere,out ds);
                if (ds != null)
                {                    
        ...
        {
            //Response.Redirect("../SearchMessage/WfrmViewSWIFT_TS.aspx?mn=" + Request["mn"].ToString());
            string strPage;
            strPage = "../SearchMessage/WfrmViewSWIFT_TS.aspx?mn=" + Request["mn"].ToString();
