<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WfrmViewMsgVCB.aspx.cs" Inherits="BIDVWEB.BIDV_UC.SearchMessage.WfrmViewMsgVCB" Title="MSBGW_WEB" %>
<!--
    ...
    <table id="Table4" runat="server" width="750px" class="DialogContent">
            ...
            <td style="width:100%">
               <table id="Table1" runat="server" width="100%" >
                    ...
                    <tr align="left">
                        ...
                        <td colspan="3">
                            <asp:TextBox ID="txtReceiver" runat="server" Width="150px" 
                                Height="20px" TabIndex="2" ReadOnly="True"></asp:TextBox>
                    ...
                    <tr align="left">
                        ...
                        <td style="width:30%">                    
                            <asp:TextBox ID="txtRM" runat="server" Width="150px" 
                                Height="20px" TabIndex="3" ReadOnly="True"></asp:TextBox>
                        </td>  
                        <td style="width:15%">
                            <asp:Label ID="Label3" runat="server" Text="Số bút toán"></asp:Label>
                        </td>                         
                        <td style="width:30%">
                    ...
                    <tr align="left">
                        ...
                        <td>
                            <asp:TextBox ID="txtAmount" runat="server" Width="150px" 
                                Height="20px" TabIndex="5" ReadOnly="True"></asp:TextBox>
                            <asp:Label ID="lblCCY" runat="server"></asp:Label>
                        </td>                        
                        <td>
                            <asp:Label ID="Label11" runat="server" Text="Loại điện"></asp:Label>
                        </td>                         
                        <td>
                            <asp:TextBox ID="txtMsgType" runat="server" Height="20px" Width="150px" 
                                ReadOnly="True" TabIndex="6"></asp:TextBox>
                            <asp:TextBox ID="txtMsgDirection" runat="server" Height="20px" Width="20px" 
                                ReadOnly="True" TabIndex="6" Visible="false"></asp:TextBox>
                        </td>                        
                    </tr>
                    <tr align="left">
                        <td>
                            <asp:Label ID="Label8" runat="server" Text="Ngày giao dịch"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtTransDate" runat="server" Width="150px" ReadOnly="True" 
                                Height="20px" TabIndex="7"></asp:TextBox>
                        </td>                        
                        <td>
                            <asp:Label ID="Label10" runat="server" Text="Trạng thái"></asp:Label>
                        </td>                         
                        <td>
                            <asp:TextBox ID="txtStatus" runat="server" Height="20px" ReadOnly="True" 
                    ...
                    <tr align="left">
                        ...
                        <td>
                            <asp:Label ID="Label12" runat="server" Text="Trạng thái in điện"></asp:Label>
                        </td>                         
                        <td>
                            <asp:TextBox ID="txtPrintSTS" runat="server" Height="20px" ReadOnly="True" 
                                Width="150px" TabIndex="8"></asp:TextBox>
                        </td>                                                
                    </tr>            
                    </table>                 
        ...
        <tr>
            <td style="width:100%" valign="top">
                <asp:TextBox Width="960" ID="txtContent" runat="server" Height="250px" 
                    TextMode="MultiLine" Wrap ="True" ReadOnly="True" TabIndex="10">
                </asp:TextBox>
            </td>
        </tr>
        <tr>
            <td style="width:100%" valign="top" align="center">
                ...
                <asp:Button ID="btnPrint" runat="server" Height="25px" onclick="btnPrint_Click" 
                    Text="In điện" Width="100px" TabIndex="11" />
