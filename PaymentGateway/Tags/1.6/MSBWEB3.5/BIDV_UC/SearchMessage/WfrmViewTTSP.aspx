<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WfrmViewTTSP.aspx.cs" Inherits="BIDVWEB.BIDV_UC.SearchMessage.WfrmViewMsgManagement" Title="MSBGW_WEB" %>
<!--
    ...
    <table id="Table4" runat="server" width="750px" class="DialogContent">
        <tr>
            <td align="center" colspan="2" class="DialogCaption" style="height:25px">
                <asp:Label ID="Label6" runat="server" Font-Bold="True" Text="ĐIỆN TTSP" 
            ...
            <td style="width:100%">
               <table id="Table1" runat="server" width="100%" >
                    ...
                    <tr align="left">
                        ...
                        <td>
                            <asp:Label ID="Label12" runat="server" Text="Trạng thái điện"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtMSG_STATUS" runat="server" Width="150px" ReadOnly="True" 
                                Height="20px"></asp:TextBox>
                        </td>
                    </tr>                         
                    <tr align="left">
                        <td>
                            Ngày giao dịch</td>
                        <td>
                            <asp:TextBox ID="txtTranDate" runat="server" Width="150px" ReadOnly="True" 
                                Height="20px"></asp:TextBox>
                        </td>          
                        <td>
                            <asp:Label ID="Label3" runat="server" Text="Trạng thái in điện"></asp:Label>
                        </td>
                        <td>
