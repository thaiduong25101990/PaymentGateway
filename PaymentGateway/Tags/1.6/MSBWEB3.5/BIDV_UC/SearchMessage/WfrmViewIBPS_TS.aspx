<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WfrmViewIBPS_TS.aspx.cs" Inherits="BIDVWEB.BIDV_UC.SearchMessage.WfrmViewIBPS_TS" Title="MSBGW_WEB" %>
<!--
    ...
    <div style="font-weight: 700">
        ...
        cellpadding="0" cellspacing="0" border="0">
            ...
            <tr align="left">
                ...
                <td style="width:35%">
                    ...
                    <asp:TextBox ID="txtID" runat="server" Height="18px" 
                        TabIndex="7" ReadOnly="True" Visible="false" Width="22px"></asp:TextBox>
            ...
            <tr align="left">
                ...
                <td>
                    <asp:Label ID="Label31" runat="server" Text="CN nhận điện"></asp:Label>                           
                </td>
                <td>
            ...
            <tr align="left">
                ...
                <td>
                    <asp:Label ID="Label9" runat="server" Text="Số lệnh TS">
                    </asp:Label>
           ...
           <tr>
                <td style="width:100%" align="left" valign="top" colspan="4">
                    <asp:TextBox ID="txtContent_TS" runat="server" Height="50px" TextMode="MultiLine" 
                        Width="875px" ontextchanged="txtContent_TS_TextChanged"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="width:100%" colspan="4">
