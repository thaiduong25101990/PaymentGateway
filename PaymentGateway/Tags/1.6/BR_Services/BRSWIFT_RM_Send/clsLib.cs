...
namespace BRSWIFTRMSend
{
    class Lib
    {
        ...
        private const string SERVICE_NAME = "BRSWIFTRMSend";
        private const string LOG_FOLDER = @"C:\ServiceLog";
        private const string LOG_FILENAME = "BRSWIFTRMSend_Service.log";
        ...
        public static void WriteLogDB(int LogLevel, string Content, long lQueryID)
        {
            try
            {
                    ...
                    OracleParameter[] parameters = new OracleParameter[]
                {
                    ...
                    parameters[2].Value = "BRSWIFTRMSend";
        ...
        public static bool ISnumber(string strInput)
        {
            ...
            try
            {
                lReturn=Convert.ToInt64(strInput);
                return true;
            }
            catch 
            {
