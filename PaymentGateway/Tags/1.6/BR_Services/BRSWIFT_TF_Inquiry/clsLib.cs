...
namespace BRSWIFTTFInquiry
{
    public class Lib
    {
        ...
        private const string LOG_FILENAME = "BRSWIFTTFInquiry_Service.log";
        ...
        public static void WriteLogDB(int LogLevel, string Content, long lQueryID)
        {
            try
            {
                ...
                try
                {
                    ...
                    //    new OracleParameter("pService",SWIFTTFInquiry.SERVICE_NAME),
                    ...
                    OracleParameter[] parameters = new OracleParameter[]
                {
                    ...
                    parameters[2].Value = "BRSWIFTTFInquiry";
