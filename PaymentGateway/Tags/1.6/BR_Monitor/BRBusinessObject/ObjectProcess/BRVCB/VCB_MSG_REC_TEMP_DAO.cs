...
{
    /***********************************************
     * Doi tuong thao tac CSDL cua VCB_MSG_REC_TEMP
     ***********************************************/ 
    public class VCB_MSG_REC_TEMDP
    {
        OracleConnection oraConn = new OracleConnection();
        Connect_Process conn = new Connect_Process();
        
        public VCB_MSG_REC_TEMDP()
        {
        }

        public static VCB_MSG_REC_TEMDP Instance()
        {
            return new VCB_MSG_REC_TEMDP();
        }
        /***********************************************
         * Them du lieu vao bang VCB_MSG_REC_TEMP
         ***********************************************/ 
        public int AddVCB_MSG_REC_TEM(VCB_MSG_REC_TEMPInfo objTable)
        {
            string strSql = "INSERT INTO VCB_MSG_REC_TEMP (GW_TYPE, ACC_NUM,";
            ...
            OracleParameter[] oraParam = {new OracleParameter("pGW_TYPE", OracleType.VarChar, 10),
                                         ...
                                         new OracleParameter("pRUNNING_SEG_NO",OracleType.VarChar,10),
                                         new OracleParameter("pREF_NO",OracleType.VarChar,16),
                                         new OracleParameter("pMSG_TYPE",OracleType.VarChar,15),
                                         new OracleParameter("pSEG_NO",OracleType.VarChar,10),
                                         new OracleParameter("pMSG_NO", OracleType.VarChar, 10),
                                         new OracleParameter("pCCY", OracleType.VarChar, 4),
                                         new OracleParameter("pAMOUNT", OracleType.VarChar, 18),
                                         ...
                                         new OracleParameter("pJOURNAL_SEG_NO", OracleType.VarChar, 18),
        ...
        /***********************************************
         * Xoa bang VCB_MSG_REC_TEMP
         ***********************************************/ 
        public int ClearVCB_MSG_REC_TEM(string dDate, string strDepartment)
        {
            string strSql = "DELETE FROM VCB_MSG_REC_TEMP";
        ...
        /***********************************************
         * Lay du lieu bang VCB_MSG_REC_TEMP
         ***********************************************/ 
        public DataSet GetVCB_MSG_REC_TEM(string strDirection, string strDepartment)
        {
            DataSet datDs = new DataSet();
            string strSQL = "Select * from VCB_MSG_REC_TEMP Where Upper(APP_CODE)='" + strDepartment + "' AND Upper(MSG_DIRECTION) ='" + strDirection + "' order by ACC_NUM, ACC_TYPE, SEG_NO ASC";
