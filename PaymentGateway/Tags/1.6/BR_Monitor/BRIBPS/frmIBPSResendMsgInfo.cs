...
namespace BR.BRIBPS
{
    public partial class frmIBPSResendMsgInfo : frmBasedata
    {
        ...
        //khi load  form
        private void frmIBPSResendMsgInfo_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                lbSend_Bankname.Text = GetIBPSBankname(strSendingBank.Trim());
                //----------------------------------------------------------------
               ...
               // string strFIELD_NAME1 = "028";
                ...
                //----------------------------------------------------
                //txtsen_receipt_time.Text = frmIBPSResend.strSend_receipt;
      ...
      // lay ra thong tin lich su dien
        ...
        private void frmIBPSResendMsgInfo_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                if (iClose == false)
        ...
        private void frmIBPSResendMsgInfo_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                Common.bTimer = 1;
        ...
        private void frmIBPSResendMsgInfo_MouseMove(object sender, MouseEventArgs e)
        {
            Common.bTimer = 1;
        }
