...
{
    public partial class frmVCBResendInfo : BR.BRSYSTEM.frmBasedata
    {
        ...
        private void frmVCBResendInfo_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                try
                {
                    ...
                    //lblRefNo.Text = frmVCBResend.strRefNo;//HaNTT10
                }
                catch (Exception ex)
                {
                    Common.ShowError(ex.Message, 2, MessageBoxButtons.OK);
        ...
        private void frmVCBResendInfo_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                if (iClose == false)
        ...
        private void frmVCBResendInfo_KeyDown(object sender, KeyEventArgs e)
        {
            Common.bTimer = 1;
        }

        private void frmVCBResendInfo_MouseMove(object sender, MouseEventArgs e)
        {
            Common.bTimer = 1;
        }
