...
{
    public partial class WfrmIBPS_TS : System.Web.UI.Page
    {
        ...
        {            
            try
            {
                ...
                ds = objIBPS_TS_BO.SearchAdvance(strWhere,out ds);
                if (ds != null)
                {                    
        ...
        {
            //Response.Redirect("../SearchMessage/WfrmViewIBPS_TS.aspx?mn=" + 
            //    Request["mn"].ToString(), false);
            string strPage;
            strPage = "../SearchMessage/WfrmViewIBPS_TS.aspx?mn=" + Request["mn"].ToString();
